...
#ifndef _CAMERA_SENSOR_PARA_GC0313MIPI_YUV_H
#define _CAMERA_SENSOR_PARA_GC0313MIPI_YUV_H
...
typedef enum
{
	...
	/* STRUCT: SENSOR */
#define GC0313MIPI_YUV_CAMERA_SENSOR_REG_DEFAULT_VALUE \
		/* ARRAY: SENSOR.reg[11] */\
		{\
			/* STRUCT: SENSOR.reg[0] */\
			{\
...
#define GC0313MIPI_YUV_CAMERA_SENSOR_CCT_DEFAULT_VALUE {{0xFFFFFFFF,0xFFFFFFFF},{0xFFFFFFFF,0xFFFFFFFF}}


#endif//#ifndef _CAMERA_SENSOR_PARA_GC0313MIPI_YUV_H
