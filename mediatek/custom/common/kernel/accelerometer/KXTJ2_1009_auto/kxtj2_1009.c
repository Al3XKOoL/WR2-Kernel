...
//<BEGIN><><20140617>wangyanhui
 ...
 #endif
 	dat[KXTJ2_1009_AXIS_X] = obj->cali_sw[KXTJ2_1009_AXIS_X];
	dat[KXTJ2_1009_AXIS_Y] = obj->cali_sw[KXTJ2_1009_AXIS_Y];
	dat[KXTJ2_1009_AXIS_Z] = obj->cali_sw[KXTJ2_1009_AXIS_Z];
 //<END><><20140617>wangyanhui
...
#endif
	obj->cali_sw[KXTJ2_1009_AXIS_X] = dat[KXTJ2_1009_AXIS_X];
	obj->cali_sw[KXTJ2_1009_AXIS_Y] = dat[KXTJ2_1009_AXIS_Y];
	obj->cali_sw[KXTJ2_1009_AXIS_Z] = dat[KXTJ2_1009_AXIS_Z];

	GSE_ERR("cali_sw: (%+3d %+3d %+3d)\n", 
		obj->cali_sw[KXTJ2_1009_AXIS_X], obj->cali_sw[KXTJ2_1009_AXIS_Y], obj->cali_sw[KXTJ2_1009_AXIS_Z]);
//<END><><20140617>wangyanhui
#else
...
static int KXTJ2_1009_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	else
	{
		...
		acc[KXTJ2_1009_AXIS_Z] = acc[KXTJ2_1009_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;		
	        ...
	        //<BEGIN><><20140617>wangyanhui
		acc[KXTJ2_1009_AXIS_X] += obj->cali_sw[KXTJ2_1009_AXIS_X];
		acc[KXTJ2_1009_AXIS_Y] += obj->cali_sw[KXTJ2_1009_AXIS_Y];
		acc[KXTJ2_1009_AXIS_Z] += obj->cali_sw[KXTJ2_1009_AXIS_Z];
		//<END><><20140617>wangyanhui
