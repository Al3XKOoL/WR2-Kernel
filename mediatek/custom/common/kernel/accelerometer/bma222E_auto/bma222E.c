...
#endif
	dat[BMA222_AXIS_X] = obj->cali_sw[BMA222_AXIS_X];
	dat[BMA222_AXIS_Y] = obj->cali_sw[BMA222_AXIS_Y];
	dat[BMA222_AXIS_Z] = obj->cali_sw[BMA222_AXIS_Z];
//<END><><20140611>wangyanhui
...
//<BEGIN><><20140611>wangyanhui
	...
	obj->cali_sw[BMA222_AXIS_X] = dat[BMA222_AXIS_X];
	obj->cali_sw[BMA222_AXIS_Y] = dat[BMA222_AXIS_Y];
	obj->cali_sw[BMA222_AXIS_Z] = dat[BMA222_AXIS_Z];
...
static int BMA222_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	else
	{
		...
		acc[BMA222_AXIS_Z] = acc[BMA222_AXIS_Z] * GRAVITY_EARTH_1000 / obj->reso->sensitivity;		
	        ...
	        //<BEGIN><><20140611>wangyanhui
		acc[BMA222_AXIS_X] += obj->cali_sw[BMA222_AXIS_X];
		acc[BMA222_AXIS_Y] += obj->cali_sw[BMA222_AXIS_Y];
		acc[BMA222_AXIS_Z] += obj->cali_sw[BMA222_AXIS_Z];
		//<END><><20140611>wangyanhui
